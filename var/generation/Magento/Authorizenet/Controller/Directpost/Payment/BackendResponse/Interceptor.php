...
class Interceptor extends \Magento\Authorizenet\Controller\Directpost\Payment\BackendResponse implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\Action\Context $context, \Magento\Framework\Registry $coreRegistry, \Magento\Authorizenet\Helper\DataFactory $dataFactory, \Magento\Authorizenet\Model\DirectpostFactory $directpostFactory = null, \Psr\Log\LoggerInterface $logger = null)
    {
        $this->___init();
