...
class Interceptor extends \Magento\Catalog\Model\Indexer\Category\Product\Action\Full implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\ResourceConnection $resource, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Catalog\Model\Config $config, \Magento\Framework\DB\Query\Generator $queryGenerator = null)
    {
        $this->___init();
        parent::__construct($resource, $storeManager, $config, $queryGenerator);
    }
